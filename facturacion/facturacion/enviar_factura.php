<?php
	...
	foreach($lista_correos as $index => $correo){
		$contactos[] = array('email'=>strtolower(trim($correo)), 'name'=>"Nombre");
	}
	...
	'folio'=> $_GET["folio"],
	'url_pdf'=> "www.pakmailejercito.com.mx/sistema/facturacion/facturacion/". $_GET["url_pdf"],
	'url_xml'=> "www.pakmailejercito.com.mx/sistema/facturacion/facturacion/". $_GET["url_xml"]
	);
	...
	try {
		...
		// print_r($result);
		$respuesta["sendTransacEmail"] = $result;
