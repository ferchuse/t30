<?php
	...
	//Si ya tiene factura trear los datos de la factura
	if($venta["fila"]["id_facturas"] != ""){
		$factura = getFactura($venta["fila"]["id_facturas"]);
	}
...
<html lang="es">
	...
	<body>
		<?php
			...
			//Evitar facturar de meses anteriores
			$fecha_boleto = strtotime($_GET["fecha"]);
			
			if (
			date("Y-m", $fecha_boleto) != date("Y-m")
			) {
				
				echo "<div class='alert alert-warning text-center h4'>
				<i class='fa fa-calendar-times'></i><br>
				El boleto corresponde al periodo de <strong>" .
				strftime("%B de %Y", $fecha_boleto) .
				"</strong> y ya está fuera del periodo de facturación.
				<br><br>
				Solo es posible facturar boletos del mes actual.
				<br><br>
			...
			//Boleto previamente facturado,
			
			//TODO falta agregar boletos de factura global
			...
			<div class="container mt-4">
				...
				<div id="descargar" class="alert alert-success text-center">
					<a target="_blank" href="<?php echo URL_SISTEMA."facturacion/facturacion/".$factura["url_pdf"]?>" class="btn btn-success" ">
					<i class="fas fa-file-pdf"></i> Descargar PDF
				</a>
				<a target="_blank" href="<?php echo URL_SISTEMA."facturacion/facturacion/".$factura["archivo_xml"]?>"  class="btn btn-info"  >
