	...
	<tbody id=""> 
		...
		<?php
			...
			<tr>
				...
				<td class="text-left"><?php echo $row["razon_social_emisores"]; ?></td>
				...
				<td class="text-center hidden-print"> 
					<div class="btn-group">
						<a hidden class="btn btn-default btn_vista <?php echo $cancelada == '1' ? "hidden" : ''; ?>" target="_blank" title="Vista Previa"  href="facturacion/vista_previa.php?id_facturas=<?= $id_facturas;?>">
							<i class="fa fa-eye" ></i>
						</a>
