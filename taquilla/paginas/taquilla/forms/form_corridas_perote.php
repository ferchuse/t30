				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="form-group col-sm-4">
							...
							<?php echo generar_select($link, "taquillas_perote", "id_taquilla", "nombre_taquilla", false, false, true, $_COOKIE["id_recaudaciones"]) ;	?>
						</div>
					</div>
					<div class="form-row">
						...
						<div class="form-group col-5">
							...
							<select  required class="form-control"  name="destino" id="destino">
								...
								<option selected>ALVARADO</option>
							</select>
						</div>
					</div>
					<div class="form-row">
