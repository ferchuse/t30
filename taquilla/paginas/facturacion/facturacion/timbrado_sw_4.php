<?php
	...
	if(isset($_POST["factura_global"])){
		$factura_global = 'SI';
		$cfdi['InformacionGlobal']["Periodicidad"] = $_POST["periodicidad"];
		$cfdi['InformacionGlobal']["Meses"] = $_POST["mes"];
		$cfdi['InformacionGlobal']["Año"] = $_POST["year"];
	...
	// Datos del Receptor
	$cfdi['Receptor']['Rfc'] = strtoupper(trim($_POST["rfc_clientes"]));
	$cfdi['Receptor']['Nombre'] = strtoupper(trim($_POST["razon_social_clientes"]));
	...
	if($respuesta["timbrado"]["status"] == "success"){
		...
		$new_path = "../../../../facturacion/facturacion/timbrados/".$prefix."_".$rfc."_".$folio_facturas."_".substr($respuesta["timbrado"]["data"]["uuid"], -5);
		...
		$insert_facturas.=" archivo_png = '$new_path.jpg',";
		...
		$insert_facturas.=" factura_global = '{$factura_global}', ";
		
		if(isset($_POST["factura_global"])){
			$insert_facturas.=" periodicidad = '{$_POST["periodicidad"]}', ";
			$insert_facturas.=" mes = '{$_POST["mes"]}', ";
			$insert_facturas.=" year = '{$_POST["year"]}', ";
		}
		...
		//Actualiza Folios
		if($folio_facturas != "" && $produccion == "SI"){
			$folio_facturas++;
