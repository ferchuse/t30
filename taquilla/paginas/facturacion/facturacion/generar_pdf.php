<?php
	...
	$respuesta["correo"] = $datos_factura["correo_clientes"];
	$respuesta["folio"] = $datos_factura["folio_facturas"];
	...
	if(!file_put_contents($ruta_timbrados.$datos_factura["url_pdf"], $pdf_file)){
	...
	function get_factura_html($datos_factura){
		...
		if($_SERVER["SERVER_NAME"] == "localhost"){
			$url = $_SERVER['HTTP_HOST']."/taxidriver/taquilla/paginas/facturacion/facturacion/plantilla_pdf.php";
			
		}
		else{
			$url = "https://".$_SERVER["SERVER_NAME"]."/taquilla/paginas/facturacion/facturacion/plantilla_pdf.php";
