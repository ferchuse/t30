<?php
	...
	include('../../conexi.php');
	$link = Conectarse();
	$nombre_pagina = "Importes Por Fecha de Corrida";
...
<html lang="es_mx">
    ...
    <script >
			...
			function listarRegistros(){
				...
				return $.ajax({
					url: 'control/lista_importes_usuario_corrida.php',
